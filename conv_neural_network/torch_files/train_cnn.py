...
conv_layers = Convolutional_Layers_Torch(3, [[16,5], [32,3], [64,3]], ['relu', 'relu', 'relu'], images.shape, batch_size, strides=strides, weight_init=None)
...
images = torch.cat((images[:100], images[14000:14100]), dim=0)
target = torch.cat((target[:100], target[14000:14100]), dim=0)
print("\n\n\n\n\n")
